...
/*   Updated: 2024/04/24 10:48:59 by corin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (mlx_image_to_window(game->mlx, game->imgs.wall,
			x_pos * 64, y_pos * 64) < 0)
...
{
	if (mlx_image_to_window(game->mlx, game->imgs.floor,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
}
...
void	draw_exit(t_game *game, size_t x_pos, size_t y_pos)
{
	if (mlx_image_to_window(game->mlx, game->imgs.floor,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
	if (mlx_image_to_window(game->mlx, game->imgs.exit,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
}
...
void	draw_player(t_game *game, size_t x_pos, size_t y_pos)
{
	if (mlx_image_to_window(game->mlx, game->imgs.floor,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
	if (mlx_image_to_window(game->mlx, game->imgs.player,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
...
void	draw_collectible(t_game *game, size_t x_pos, size_t y_pos)
{
	if (mlx_image_to_window(game->mlx, game->imgs.floor,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
	if (mlx_image_to_window(game->mlx, game->imgs.collectible,
			x_pos * 64, y_pos * 64) < 0)
		ft_error("Failed to draw image to window");
